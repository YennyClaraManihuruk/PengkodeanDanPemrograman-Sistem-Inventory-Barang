  ...
  <body>
    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h1 class="page-header"style= font-size:40px;">Data Barang Masuk</h1>
          </div>
        </div>
...
<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
   ...
   <?php 
    ...
    <input type="text" class="form-control" id="exampleInputEmail1" readonly="" name="petugas" aria-describedby="emailHelp" placeholder="Masukkan Nama Petugas">
