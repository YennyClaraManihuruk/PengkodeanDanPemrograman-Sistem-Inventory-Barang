...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
               ...
               <li>
                ...
                <a href="?m=supplier&s=awal">
                  <i class="fa fa-building"></i> Data Supplier
                            ...
                            <li>
                <a href="?m=rak&s=awal">
                  <i class="fa fa-cube"></i> Data Rak Barang
                </a>
              </li>
                            <li>
      ...
      <div id="page-wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h1 class="page-header"style= font-size:40px;>Selamat Datang, <?php echo $r['nama']; ?></h1>
          </div>
        </div>
        ...
        <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-red">
                        <div class="panel-heading" style="background-color: #ADFF2F;">
                            <div class="row">
                                <div class="col-xs-3">
                        ...
                        <a href="#">
                            <div class="panel-footer">
                                ...
                                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-red">
                        <div class="panel-heading" style="background-color: #00FF7F;">
                            <div class="row">
                                <div class="col-xs-3">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-red">
                        <div class="panel-heading" style="background-color: #FFE4B5;">
                            <div class="row">
                                <div class="col-xs-3">
                  ...
                  <div class="col-lg-3 col-md-6">
                    <div class="panel panel-red">
                        <div class="panel-heading" style="background-color: #DB7093;">
                            <div class="row">
                                <div class="col-xs-3">
...
<p class="text-muted" style="font-size: 16px;">Copyright &copy; <script: #ffffff.write(new Date().getFullYear());</script> Yenny Clara Manihuruk.All rights reserved</p>
            </div>
          </div>
        </div>
      </div>
