...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
    ...
    <footer class="text-center">
      <div class="footer-below"style="background-color:background: rgb(58,155,180);
background: linear-gradient(177deg, rgba(58,155,180,1) 0%, rgba(29,147,253,1) 50%, rgba(194,69,252,1) 100%);>
        <div class="container">
          <div class="row">
            <div class="col-lg-12">
              
<p class="text-muted" style="font-size: 20px;">Copyright &copy; <script>document.write(new Date().getFullYear());</script> Yenny Clara Manihuruk. All rights reserved</p>
            </div>
          </div>
        </div>
      </div>
